              ...
              <Button
                ...
                onClick={() => {
                  if (value.name == "Facebook") {
                    window.location.href = `https://www.facebook.com/v19.0/dialog/oauth?client_id=2475636742798573&redirect_uri=${window.location.origin}callback&scope=pages_manage_posts,pages_show_list&response_type=code`;
                  }
                }}
              >
                Connect
