      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <motion.div
          ...
          <p className="text-lg dark:text-zinc-400 text-gray-700 max-w-3xl mx-auto">
            Everything you need to create, schedule, and analyze your social
            media content in one powerful platform.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="dark:bg-[#12121a]/80 dark:backdrop-blur-md bg-white/70 backdrop-blur-sm rounded-2xl p-6 dark:border-violet-500/10 border-violet-200/30 border hover:dark:border-violet-500/30 hover:dark:bg-[#16161f]/90 hover:border-violet-300 hover:shadow-xl hover:shadow-violet-500/10 transition-all duration-300 cursor-pointer group">
              <div className="dark:bg-violet-500/10 bg-violet-100 rounded-lg p-3 w-fit mb-4 group-hover:dark:bg-violet-500/20 group-hover:bg-violet-200 transition-colors duration-300">
