      ...
      <nav className="fixed top-0 w-full transition-all duration-300 dark:bg-black/90 bg-white/90 backdrop-blur-sm z-50 dark:border-violet-900 border-violet-200">
        <div className="max-w-7xl mx-auto p-4">
          <div className="flex items-center justify-between">
            <h1 className="text-xl sm:text-2xl font-[PlaywriteHU] dark:text-violet-400 text-violet-700 font-bold">PostPilot</h1>
                ...
                <div className="relative grid grid-cols-2 gap-3 sm:gap-4 h-full">
                  ...
                  >
                    <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                      ...
                      <span className="text-xs sm:text-sm dark:text-zinc-400 text-gray-600">Connected Platforms</span>
                    </div>
                    <div className="h-16 sm:h-24 grid grid-cols-3 gap-2">
                      <div className="bg-violet-50 dark:bg-violet-900/20 rounded p-1 sm:p-2 flex flex-col items-center justify-center">
                        <span className="text-lg sm:text-2xl font-bold text-violet-600 dark:text-violet-400">45</span>
                        <span className="text-[10px] sm:text-xs text-gray-600 dark:text-zinc-400">Posts</span>
                      </div>
                      <div className="bg-violet-50 dark:bg-violet-900/20 rounded p-1 sm:p-2 flex flex-col items-center justify-center">
                        <span className="text-lg sm:text-2xl font-bold text-violet-600 dark:text-violet-400">12K</span>
                        <span className="text-[10px] sm:text-xs text-gray-600 dark:text-zinc-400">Reach</span>
                      </div>
                      <div className="bg-violet-50 dark:bg-violet-900/20 rounded p-1 sm:p-2 flex flex-col items-center justify-center">
                        <span className="text-lg sm:text-2xl font-bold text-violet-600 dark:text-violet-400">89%</span>
                        <span className="text-[10px] sm:text-xs text-gray-600 dark:text-zinc-400">Engagement</span>
                      </div>
                    </div>
                  </motion.div>
                  ...
                  >
                    <h3 className="text-xs sm:text-sm font-medium dark:text-zinc-400 text-gray-600 mb-2 sm:mb-3">Quick Schedule</h3>
                  ...
                  <motion.div
                    ...
                    className="bg-white dark:bg-black/40 rounded-lg p-3 sm:p-4 border dark:border-violet-800/50 border-violet-300/50"
                  >
                    <h3 className="text-xs sm:text-sm font-medium dark:text-zinc-400 text-gray-600 mb-2 sm:mb-3">Analytics</h3>
                    <div className="space-y-1 sm:space-y-2">
                      <div className="flex items-center gap-1 sm:gap-2 text-[10px] sm:text-xs dark:text-zinc-400 text-gray-600">
