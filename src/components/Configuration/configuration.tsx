...
import { FiFacebook, FiInstagram, FiTrash2, FiAlertCircle } from 'react-icons/fi';
  ...
  return (
    <div className='bg-white  h-[calc(100vh-2rem)] overflow-y-auto relative rounded-lg pb-4 shadow'>
      ...
      <div className="p-6 space-y-6">
        {/* Section Title */}
        <div className="pb-4">
          <h2 className="text-xl border-b border-stone-200 pb-4 mb-2 font-semibold">Social Media Connections</h2>
          <p className="text-sm text-stone-500">Connect your social media accounts to enable posting</p>
            ...
            <div className='flex items-center justify-between'>
              <div className='flex justify-between items-center w-full gap-2'>
                <div>
                  ...
                  <h3 className='text-sm text-stone-500'>Once you delete a channel, there is no going back. Please be certain.</h3>
                </div>
                <button onClick={handleDeleteChannel} className='text-red-600 text-sm bg font-bold hover:bg-red-700 duration-300 hover:text-white transition-colors rounded-lg border bg-stone-100 border-red-200/50 px-4 py-2'>Delete Channel</button>
              </div>
