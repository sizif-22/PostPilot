        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <section className="mb-8">
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
              Welcome to PostPilot! These Terms of Service (&quot;Terms&quot;) govern your use of our social media
              automation platform and related services (the &quot;Service&quot;). By accessing or using PostPilot, you
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              You must be at least 18 years old or the age of majority in your jurisdiction to use PostPilot. By using
              our Service, you represent and warrant that you meet these requirements.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4 mb-4">
              ...
              <li>Do not attempt to gain unauthorized access to any part of the Service or its systems.</li>
              <li>Do not interfere with or disrupt the integrity or performance of the Service.</li>
              <li>Do not upload or share content that is illegal, offensive, or infringes on the rights of others.</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              You retain ownership of the content you create and upload to PostPilot. By using the Service, you grant us
              a non-exclusive, worldwide, royalty-free license to use, display, and distribute your content as necessary
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              All intellectual property rights in the Service, including software, design, and trademarks, are owned by
              PostPilot or its licensors. You may not use, copy, or distribute any part of the Service without our prior
              written consent.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              that violates these Terms or is otherwise harmful to PostPilot or other users.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              the fullest extent permitted by law, PostPilot disclaims all warranties and is not liable for any damages
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              updated Terms on our website or by other means. Your continued use of PostPilot after the effective date
          ...
          <div className="border-t border-gray-200 pt-6">
            <p className="text-sm text-gray-600 italic">
              These Terms of Service are designed to be clear and transparent. Please review them regularly to stay
              informed about your rights and obligations when using PostPilot.
            </p>
          </div>
        </div>
      </main>
